function Invoke-RemovalContent{
    <#PSScriptInfo
    .SYNOPSIS
        Removing files / folder
    .DESCRIPTION
        To delete files + folder (if empty)
    .PARAMETER Folder
        What is the folder path
    .PARAMETER RetentionPeriod
        What is the Retention Period to search for
    .PARAMETER ExcludeExtensionToSearch
        What is extension for files not to remove
    .EXAMPLE 
        Invoke-RemovalContent 'C:\temp\' 7
        Invoke-RemovalContent 'C:\temp\' 7 '*.csv'
        Invoke-RemovalContent 'C:\temp\' 7 '*.csv,*.txt'
    #>
    [CmdletBinding()]
    param 
    ( 
        [parameter(Mandatory=$true)][System.IO.FileInfo]$Folder,
        [parameter(Mandatory=$true)][int] $RetentionPeriod,
        [parameter()][string[]] $ExcludeExtensionToSearch = $null
    )	
    
    if (-not (Test-Path $Folder)) {return};
    
    
    $Folderlimit = (get-date).AddDays(-$RetentionPeriod);
    
    # Delete files older than the $limit.
    Get-ChildItem -Path $Folder -Recurse -Force -Exclude $ExcludeExtensionToSearch | Where-Object { !$_.PSIsContainer -and $_.LastWriteTime -lt $Folderlimit } | ForEach-Object {Remove-Item $_.FullName -Force | Out-Null }
    
    # Delete any empty directories left behind after deleting the old files.
    Get-ChildItem -Path $Folder -Recurse -Force | Where-Object { $_.PSIsContainer -and (Get-ChildItem -Path $_.FullName -Recurse -Force | Where-Object { !$_.PSIsContainer }) -eq $null } | ForEach-Object {Remove-Item $_.FullName -Force | Out-Null }
    }

# SIG # Begin signature block
# MIIYEwYJKoZIhvcNAQcCoIIYBDCCGAACAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUlaMUiMaJsm/DbS8OUymci1ZR
# ZregghJ/MIIFPDCCAySgAwIBAgIQTWjUKzekWKhOweWTZNRm1jANBgkqhkiG9w0B
...
# BgorBgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQUu2fy
# 0LOEIMzTQ+yQRnLV1Vidfg0wDQYJKoZIhvcNAQEBBQAEggIAcSnYIyGCdXwhqna4
# qgP7e32eKJdJ49FY6mh7RfIVzHRkHjIqNROvDFkIOpMdGh64Ne1bxQ+Wis9QHPIW
# uCrx0ejzDxoFI+asOwcCvpud5pwzep36LSCUU/EzNBpJnR+8yaQvo/vwSkT9AGLq
# 79i/Q0Z8LPzYfAyhZbSrPnP2fZEv5nInVm3fKE6qX3lB9D2k3mA+teZe7lDhIO4Z
# smM4F4AOmH3wfO0JH8XcllR7E6LGekjRCiszMsHW+8EOwT9RwEKoFfQxna1Vr12K
# 0ZBXiWpbBCzrl0cOXLi5Tt4rDQKmFp9PbkyLl2IV3hPbHDuTiwVPR1S4HWhUPuY0
# 1u/lgBpHtFwI3JpDJaXnrigF/ZwbfEkP/NfSV/xvtlYAMMhVdLF++l16tsuzlZLF
# V9yGI2//x59n19EGbfwoXezyCXw1dp892BdT0A/ToUO4O3pDYRJtR5h6dBZXAqqv
# wqrr1XiApBhcZlLKBG8xQL0c/Im8dMjKjUFVsiGRgd+i8KEHN4T2FPmIvPWw5jdP
# vzLycn/Dek71a/tm7qJZLAokBzK7N4nxb6pQoDFimnqyo8WNed0wuPeHGqpXERR9
# 0DHCaMFLQNrLjKVGUYss1+gQO+F+N2ni15+DASAMRYnJtPvEZKt5fV2GwaUn2iNm
# rouNqjyNIkToYQy/0NjcytMpKPihggIPMIICCwYJKoZIhvcNAQkGMYIB/DCCAfgC
...
# IwYJKoZIhvcNAQkEMRYEFA812NOWytSzfN2xSFNLzRyIpxhRMA0GCSqGSIb3DQEB
# AQUABIIBAJXK+bol5pYf3P3pfh1trce6P51JEkClEGrQbRg0oheAYhMDG/5qiW5y
# 4wqM7iSqhFvzYf5I1A5mtydx7Cho6qh6p+M/fDD4pNnXwuoreBbSfw+8QrW1qu/A
# AijUbFCbXP+jcUkCJqXvfOsvPR/GFz2xI7Emhh85C7aOqRVZuj7yxscNBLQZYQli
# J//b0s45haD9UFhdObs+Sv3GcEu68vZPba3lEJXBRAuTkyihE9PMunf+Z25rGe+7
# /hhFq3W0ISQiOU30tlFC/CCflxC2ICSr2x3R7lHF2hL56EEtC5/WuS1USKkkWZce
# QYd0fUKVxSkgTQuvOPoZmRKX9tvxbXg=
