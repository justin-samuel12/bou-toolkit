function Get-DecryptPassword 
{
    <#PSScriptInfo
    .SYNOPSIS
        Allow to decrypted password that was encrypted using a key
    .DESCRIPTION
    ...
    .EXAMPLE 
        Get-DecryptPassword -key '01d74082f4c4aa25efdd74a8c8410ea41bd46ef88c504f19c1ff270d0b03bbb9' -value ''
    #>
    [CmdletBinding()]
    param 
    ( 
        [Parameter(Mandatory=$true,ValueFromPipeline)][string]$Key, 
        [Parameter(Mandatory=$true,ValueFromPipeline)][string]$Value 
    ) 
            
        $securestring = $Value | ConvertTo-SecureString -Key (Convert-FromStringToByte $Key)
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU3URuc5+kPJUM1ZXZc7tFC/58
# 7w+gghJ/MIIFPDCCAySgAwIBAgIQTWjUKzekWKhOweWTZNRm1jANBgkqhkiG9w0B
...
# BgorBgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQUQNXj
# YeJQdrRBWW7glnBVwTeyplowDQYJKoZIhvcNAQEBBQAEggIAafA9pHjR7Zp/xSRo
# bDHrGkxciKLojCgwE/isVHjlua1DJ++iBmADlzX74tUVfMhwsun0KItZjp1kKtsJ
# sfzegfE5/CTt/5R7qtluoVedHHOWVI0eiVL+q6b4ikcgdoQJajo5Ydk/Wv3QobUF
# w36vXeTPAmlsGGX0pJFHRYdiK19dF94fT+0IELOWIde3/1HVkyB6m3HQwe1bT57q
# 152hG6kMlYetkv29isxdsIk5CKQ6Kkgt/wKRHy66+RB2jgErKtuWtC5tSJ0BDcca
# lvqRAMF8Y4f9BIqsS8SDSuIvnvd53lwalhOy73TiVqQa2GhUVQRTjjvIYqVuKeFo
# dadgk6yBz+C0Uu2C87T9WTXLXUODynY9wXql16+8Q8tNJSp+dnUY60ReVlqOSkqe
# k34UMwhojcW9U+b8F3Q0l6C7YnrEsc+f3U7jomMeYRVD2t69tvxyrLzQmUOO1cp9
# IdkqxBwHzqKbTu3XG7wB9F61qBMEjMyfyI8ktA8ECtS70DAzsqpDYKV68J0XQS5s
# XElbMA5kYDlS2XQeM1jSDiibW3J2RImfn1LY8H6WRw7E+l3EGnDKHkFnpT/UGiR1
# q/wlVYY4M+AkK/1dlgH9QiwtiX9StXFiKoylTDImOSD4L0qWMA4v7qKLTL5rgBms
# 4TkPj6EVzGUgvHdfMCv3ijYaPlehggIPMIICCwYJKoZIhvcNAQkGMYIB/DCCAfgC
...
# IwYJKoZIhvcNAQkEMRYEFCBBR64+eJJmFptWr7vtx+KmSLHGMA0GCSqGSIb3DQEB
# AQUABIIBACM05SXgXblE8262kd3hST08wWHWJp1FMqgHKcDeMDmvDZ2TI+xmGWPi
# pRuNV7/gctQvuWqlq/X6nMc2pQJYVgI28Z+JBDwuu5Gx6ZdDNVchGPh8mqwEzNwk
# 3s/ZkKncs+u9z6DYsqdugE6hnjK2IlJ5DzNhyb4AUd2Kw4ibfHxjtMUIO96PHlIM
# moMbSO/t+6BwVnDZn6mxOdZhpxopRg9xpME4nlJf/KPwKXiUf6APctxzfXug0jJ8
# uBYf8FO3WMaknSEuSx2JcIthcVUS8SOipgM/4knX0DjFFll78Kmvm6mKW3o3j9V6
# FdwuiFKZlrdb/eDzWtjQMTysqrb8qpA=
