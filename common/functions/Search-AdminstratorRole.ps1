function Search-AdminstratorRole {
    <#PSScriptInfo
    .SYNOPSIS
        search if current user is in administrator role
    .DESCRIPTION
        search if current user is in administrator role
    .NOTES
        Author: Justin-Samuel
    .EXAMPLE 
        Search-AdminstratorRole
    #>
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUftpGsOZ+1kZNYbTTjBAV00P8
# V5SgghJ/MIIFPDCCAySgAwIBAgIQTWjUKzekWKhOweWTZNRm1jANBgkqhkiG9w0B
...
# BgorBgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQUJfho
# gIvTXrcWtjVJpl1DZnxIhVAwDQYJKoZIhvcNAQEBBQAEggIAlUXq8uHC+OCP9nGW
# RAN7wktAPtekw3lEiEtXqrsRKu2Ecw3vN3ckLSqC7AcxYv4dglkZgGkrJaOPsjiY
# GCErsY7xNneE/LUm2YBxodZZAbjubnEiiuQs44HLBal4dxZmL8MnFcuTEfCdN2ra
# ygNT8zehAchuTwLq9bGd81J1vcPR0foMQUZmBOaAUv0XBtWScuNw5J8zh0YQJm3B
# PLr9JE1fbMRV3ubzIQ5UNAUh06gZ6Q6lnJ0TfhZJYVTLAlGYK07mT8xBDR6Sgvbu
# Kg0w43huUQsEGvfhw7B5bYLXSArkhNRIXjU/ZYiTYWduaYaql28HKhhGIPWIVtYE
# Ng9oSJLJ80upO/ekf5US43l0MI4nKKDDJ5vZaUKiNLpzHiJQJtNRpoYvajF5Tujl
# c7v6182dY/jnrmcEYpSGTCOLHpBPeBx+YnKQVic3mDfPP/1z5bM0T8ZGbwJt9vVH
# 8kDFzQrbqF28yIlqyngDaIAgW54bjOwuGw7/HKs85WTJo64608TC8MMpyjDOOP6O
# rt8D2bt2BUbEGA6gSIpOl6BQpxvu8/tNRa80KbYw8bg4s5nWsKCc36dyhawUWTE8
# WkePScdJpxfInuH7r3+y1UZYK4ksZ82p0jZFZ2IbpBEnsFmlkr5qzK+asFLx/MPr
# HfVeNrJ7bxv7DkutgJyCveXeGtGhggIPMIICCwYJKoZIhvcNAQkGMYIB/DCCAfgC
...
# IwYJKoZIhvcNAQkEMRYEFN4rDqRJGm5KwLkhF7qxZ3IkBSAOMA0GCSqGSIb3DQEB
# AQUABIIBAGyqJ7qpA5FNQ6TMT4bWbrB7mJ/DZ6zppZ9wK34ZkaOwpVIbErn/bKL3
# TmVKc71T0iSQOYtgU7qLYmcLE4dlPR7PyDClnbm2qBLnp1ZWtqN3xIrl2uHEumdw
# ZALkEUEoY3XB9IRe3MxJ5GZJxDFRl2MruEtY5uVJYdbpRwD1C5FByo2htqdcq+30
# sx1tZlh9QFIzm6W1uU++XNM+8/1sEoC/xAX+mxe5Gpc+H4RP/Z59A9hkkZ7Wy4nK
# kbFFzmw7oDFXDxhRklk8aNbDxiGTs4N3pLt+IXrOEpFJZXtjh+POoWWiGAN871y+
# BwKpvZXMTqQffHt0YvW7co8QLwXwafU=
